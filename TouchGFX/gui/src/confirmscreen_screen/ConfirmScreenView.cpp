// --- File: src/gui/src/confirmscreen_screen/ConfirmScreenView.cpp ---
...
ConfirmScreenView::ConfirmScreenView() : patternLength(0) {}

void ConfirmScreenView::setupScreen()
{
    ConfirmScreenViewBase::setupScreen();
...
touchgfx::Widget* ConfirmScreenView::getDot(uint8_t index)
{
    switch(index) {
        case 0: return &dot0;
        case 1: return &dot1;
...
void ConfirmScreenView::tearDownScreen()
{
    ConfirmScreenViewBase::tearDownScreen();
}

void ConfirmScreenView::resetPattern()
{
    patternLength = 0;
...
void ConfirmScreenView::checkDotTouch(int16_t x, int16_t y)
{
    CHECK_DOT(dot0, 0);
    CHECK_DOT(dot1, 1);
    CHECK_DOT(dot2, 2);
...
void ConfirmScreenView::handleClickEvent(const touchgfx::ClickEvent& evt)
{
    ConfirmScreenViewBase::handleClickEvent(evt);
...
void ConfirmScreenView::handleDragEvent(const touchgfx::DragEvent& evt)
{
    ConfirmScreenViewBase::handleDragEvent(evt);
...
void ConfirmScreenView::showError()
{
    resetPattern();
}
